...
const navButtonClass = computed(() => {
    return {
        ...
        'bg-green-50 text-green-700': activeNav === navId,
        'text-gray-600 hover:text-gray-900 hover:bg-gray-50': activeNav !== navId
    }
})
...
<template>
                  ...
                  <div class="absolute bottom-0 inset-x-0 p-4">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <div class="flex items-center gap-1 text-white/70 text-xs">
                        ...
                        <span class="text-white font-medium">{card.rating.toFixed(1)}</span>
                        <span>({card.reviews} ulasan)</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- {/* EXPLORE */} -->
      <section ref={exploreRef} id="explore" class="py-20 lg:py-28 bg-white">
              ...
              >
                <div class="relative h-56 overflow-hidden bg-gray-100">
                  ...
                  <div class="absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 rounded-full bg-white shadow-sm">
                    ...
                    <span class="text-gray-800 text-xs font-semibold">{dest.rating}</span>
                  </div>
                </div>
      ...
      <!-- {/* TOUR SCHEDULE */} -->
      <section ref={scheduleRef} id="schedule" class="py-20 lg:py-28 bg-gray-50">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
          <div class="mb-10">
                ...
                >
                    ...
                    <div class="flex-1 p-4 lg:p-5">
                      ...
                      <div class="mb-3">
                        <div class="flex justify-between text-xs mb-1">
                          ...
                          <span class="text-gray-400">{joined}/{tour.totalSlots}</span>
                        </div>
                      ...
                      <div class="flex items-center justify-between">
                        <div>
                          <span class="font-['Fraunces',serif] font-bold text-gray-900">{tour.price}</span>
                  ...
                  <div class="border-t border-gray-50 bg-gray-50 px-4 lg:px-5 py-2.5 flex flex-wrap gap-2">
                    {tour.includes.map((inc) => (
                      <span key={inc} class="text-xs text-gray-500 px-2.5 py-1 bg-white rounded-full border border-gray-100">
                        {inc}
                      </span>
                    ))}
                  </div>
      ...
      <!-- {/* ABOUT US */} -->
      <section ref={aboutRef} id="about" class="py-20 lg:py-28 bg-white">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
